...
import com.test.wdoctor.videochat.BaseConst;
import com.test.wdoctor.videochat.BussinessCenter;
import com.test.wdoctor.videochat.UserItem;

public class DialogFactory {
	
	private static final String TAG = LogUtil.makeLogTag(DialogFactory.class);
