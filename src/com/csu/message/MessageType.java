...
//	
//	/**拒绝文件通道注册请求 	 */
//	public static final int FileSockectRegResponse_SysError                    =0;
//	
//	/** 当服务器无用户的文件通道   接受文件通道注册请求 	 */
//	public static final int FileSockectRegResponse_NoFileSockect               =1;
//	
//	/** 当服务器有用户的文件通道  不接受文件通道注册请求  */
//	public static final int FileSockectRegResponse_HaveFileSockect             =2;
	...
	/**系统提醒用户好友上线信息 	 */
	public static final int SysMessage_Online                 =0;
	/**系统提醒用户好友下线信息 	 */
	public static final int SysMessage_Exit                   =1;
	/**系统提醒用户新闻信息 	 */
	public static final int SysMessage_News                   =2;
	
	
	
	/**系统的qq	 */
	public static final String sysQQ                          ="10001";
