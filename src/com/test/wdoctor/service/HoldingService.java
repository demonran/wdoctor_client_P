 ...
 * @author 
 */
public class HoldingService extends Service {

    private static final String LOGTAG = LogUtil.makeLogTag(HoldingService.class);
    ...
    public void connect()
    {
    	ExecutorUtil.submit(new Runnable() {
			...
			@Override
			public void run() {
		    	chatSocket.startSocket(HoldingService.this);
    ...
    public class MyBinder extends Binder{
   	 public HoldingService getService() {  
            return HoldingService.this;  
        }  
